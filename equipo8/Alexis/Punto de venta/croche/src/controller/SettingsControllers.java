  ...
  public SettingsControllers (SystemViews views){
    ...
    public void mouseEntered(MouseEvent e) {
        if(e.getSource()==views.jLabelProductos){
         views.jPanelProductos.setBackground(new Color(152,202,63));
        }
    ...
    public void mouseExited(MouseEvent e) {
         if(e.getSource()==views.jLabelProductos){
         views.jPanelProductos.setBackground(new Color(255,204,255));
        }
        else if(e.getSource()==views.jLabelPurchases){
            views.jPanelPutchase.setBackground(new Color(255,204,255));
        }
                 else if(e.getSource()==views.jLabelSales){
            views.jPanelSales.setBackground(new Color(255,204,255));
        }
         else if(e.getSource()==views.jLabelCustomers){
            views.jPanelCustomers.setBackground(new Color(255,204,255));
        }
         else if(e.getSource()==views.jLabelEmployes){
            views.jPanelEmployes.setBackground(new Color(255,204,255));
        }
         else if(e.getSource()==views.jLabelSuplimers){
            views.jPanelSuplimers.setBackground(new Color(255,204,255));
        }
         else if(e.getSource()==views.jLabelCategorias){
            views.jPanelCategorias.setBackground(new Color(255,204,255));
        }
         else if(e.getSource()==views.jLabelReportes){
            views.jPanelReportes.setBackground(new Color(255,204,255));
        }
         else if(e.getSource()==views.jLabelSetting){
            views.jPanelSetting.setBackground(new Color(255,204,255));
        }
    }
